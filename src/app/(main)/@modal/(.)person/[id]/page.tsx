    ...
    >
      <div className="fixed inset-0 z-40">
        ...
        <div className="absolute inset-x-0 bottom-0 top-16 md:inset-0 flex justify-center">
          <div className="relative w-full max-w-4xl h-full overflow-y-auto bg-background md:rounded-2xl md:my-6 md:max-h-[92vh] animate-in slide-in-from-bottom duration-300">
